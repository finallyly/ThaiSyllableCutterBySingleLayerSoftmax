...
def sample(mylist,i,method):
    ...
    feats11 = "Gm2:"+gm2;
    feats12 = "Gp2:"+gp2;
    feats13 = "Gm1_0:"+gm1+g0;
    feats14 = "G0_p1:"+g0+gp1;
    feats15 = "Gp1p2:"+gp1+gp2;
    feats16 = "Gm1m2:"+gm1+gm2;
    feats17 = "Gm2m10:"+gm2+gm1+g0;
    feats18 = "Gm10p1:"+gm1+g0+gp1;
    feats19 = "G0p1p2:"+g0+gp1+gp2;
